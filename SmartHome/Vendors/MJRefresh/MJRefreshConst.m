...
NSString *const MJRefreshFooterStateIdleText = @"更多..";
NSString *const MJRefreshFooterStateRefreshingText = @"加载..";
NSString *const MJRefreshFooterStateNoMoreDataText = @"完成";