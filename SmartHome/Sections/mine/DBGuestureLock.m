...
-(void)setFirstTimeSetupPassword:(NSString *)firstTimeSetupPassword
{
    [[NSUserDefaults standardUserDefaults]setObject:firstTimeSetupPassword forKey:@"firstTimeSetupPassword"];
}
-(NSString *)firstTimeSetupPassword
{
    return [[NSUserDefaults standardUserDefaults]objectForKey:@"firstTimeSetupPassword"];
}
...
+(void)clearGuestureLockPassword {
     [[NSUserDefaults standardUserDefaults]setObject:nil forKey:@"firstTimeSetupPassword"];
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
